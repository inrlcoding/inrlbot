...
if (Config.WORKTYPE == 'private') {
    ...
    inrl.addCommand({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'Made by fasweeh'})

    }));
    
    inrl.addCommand({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
    ...
    inrl.addCommand({pattern: 'pink', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "inrlinee tholpikkaan ningalkavilla. Jeevitathil inrline tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "inrl says i love you 😘";
r_text[3] = "inrludeyude yudhangal Company Kanan Povunnatheyuloo";
...
await message.sendMessage(r_text[i]);
    ...
    inrl.addCommand({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
    ...
    inrl.addCommand({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    inrl.addCommand({pattern: 'pink', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
